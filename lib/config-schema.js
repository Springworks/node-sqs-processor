...
var joi = require('@springworks/input-validator').joi;
var VALID_ATTR_NAMES = [
  'All',
...
module.exports = joi.object().required().options({
  ...
  visibility_timeout: joi.number().integer().min(0).max(43200).default(30).description('The visibility timeout for the queue').unit('seconds'),
